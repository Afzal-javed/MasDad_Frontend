...
const PlanCard = ({ plan, newArea, amount, basicCost }) => {
    return (
        <div className='my-4 w-full  shadow-xl flex flex-col items-center rounded-xl '>
            <h1 className='w-full h-[3rem] bg-black text-xl rounded-t-xl flex items-center justify-center mb-3 text-white font-semibold text-center p-2' >{plan}</h1>
